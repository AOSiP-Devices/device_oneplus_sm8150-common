...
const std::map<int32_t, TouchscreenGesture::GestureInfo> TouchscreenGesture::kGestureInfoMap = {
    ...
    {4, {255, "Single Tap", "/proc/touchpanel/single_tap_enable"}},
    {5, {246, "Letter W", "/proc/touchpanel/letter_w_enable"}},
    {6, {247, "Letter M", "/proc/touchpanel/letter_m_enable"}},
    {7, {248, "Letter S", "/proc/touchpanel/letter_s_enable"}},
    {8, {250, "Letter O", "/proc/touchpanel/letter_o_enable"}},
};
